...
browser extensions, server-operator man-in-the-middle via unverified keys, lack
of forward secrecy, and server-visible metadata. These are acknowledged
limitations rather than reportable bugs, though concrete improvements to them are
very welcome as pull requests or design proposals.
